@extends('layouts.web')
@section('title', 'Blogs – MarketingAssignmentshelp UK Insights')
@section('description', 'Explore our blogs at MarketingAssignmentshelp UK. Find study tips, writing advices, and academic resources written by our experienced professional writers.')
                ...
                <div class="mb-4 recent bg-white">
                    <form role="search" method="get" action="{{ route('blogs.search') }}" class="">
                        <div class="flex gap-4">
                            ...
                            <button aria-label="Search" class="text-white p-2 text-base" type="submit" style="background: #c8102e">Search</button>
                        </div>
                    </form>
                </div>

@extends('layouts.web')
@section('title', 'Order Marketing Assignments Help UK - Fast & Quality Service')
@section('description',
    'Place your order for Marketing Assignments Help UK today. Quick, secure process to get expert-written assignments on time and with top quality.')
...
@section('content')
    ...
    <section class="text-white py-5 mb-8">
        <div class="container mx-auto py-12 px-4 md:px-24">
            <div class="space-y-5 text-center">
                <h1 class="text-black text-4xl font-semibold py-5">
                    Order Now
                </h1>
            </div>
            @if (session('error'))
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 gap-x-4 gap-y-4">
                <div class="col-span-3 lg:col-span-2">
                    <div class="bg-gradient-reverse w-full order-form-styling1 px-4 md:px-8 py-5 lg:py-10">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 gap-4">
                                    ...
                                    <select id="deadline" name="deadline"
                                        ...
                                        @foreach ($deadlines as $deadline)
                                            <option value="{{ $deadline->name }}"
                                                ...
                                                get-id="{{ $deadline->id }}">
                                                {{ $deadline->name . ' ' . Carbon\Carbon::now()->addDays($deadline->duration_in_days)->format('j \of F Y') }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-span-2 md:col-span-1">
                                    <div class="flex input-group" data-tooltip-target="slides-tooltip">
                                        <button role="button"
                                            class="py-2 px-2 rounded-l bg-black text-white btn-minus">-</button>
                                        <input id="no-of-slides" name="no_of_slides" type="number" min="0"
                                            max="100"
                                        ...
                                        <button role="button"
                                            class="py-2 px-2 rounded-r bg-black text-white btn-plus">+</button>
                                    </div>
                                    @error('no_of_slides')
                                ...
                                <div class="col-span-2 md:col-span-1">
                                    <div class="flex input-group" data-tooltip-target="posters-tooltip">
                                        <button role="button"
                                            class="py-2 px-2 rounded-l bg-black text-white btn-minus">-</button>
                                        <input name="no_of_posters" id="no-of-posters" type="number" min="0"
                                            max="100"
                                            class=" get-fares w-full border border-transparent dark:bg-[#242B51] shadow-sm dark:shadow-lg py-3 px-6 text-black text-base outline-none focus:border-primary-one-dark"
                                ...
                                <div class="col-span-2 mx-auto">
                                    <button id="btn-submit" type="submit"
                                        class="click-btn form-btn cursor-not-allowed mt-1" disabled>
                                        Submit
                                    </button>
                                </div>
                            </div>
                ...
                <div class="text-white order-first lg:order-last col-span-3 lg:col-span-1">
                    <div class="bg-gradient-reverse shadow-sm order-form-styling1 px-6 py-8">
                        <h1 class="text-2xl text-center">Your Order Summary</h1>
                        ...
                        <div class="text-color py-2">
                            ...
                            <ul class="summary-details">
                                <li>Price Per Slide: <span class="float-right" id="cost-per-slide">-</span></li>
                                <li>Price Per Poster: <span class="float-right" id="cost-per-poster">-</span></li>
                                <li>Price Per Page: <span class="float-right" id="cost-per-page">-</span></li>
                                <li>Total: <span class="float-right text-2xl font-semibold text-white"

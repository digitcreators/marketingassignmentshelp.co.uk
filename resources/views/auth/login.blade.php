            ...
            <div class="flex flex-col space-y-4 my-2 md:my-0 lg:flex-row lg:mx-4">
                ...
                <div class="panel w-full sm:w-[70%] lg:w-[35%] mx-auto">
                    <form action="{{ route('login') }}" method="POST"
                        class="bg-white shadow-md rounded-lg px-4 pt-2 pb-6 flex flex-col w-full space-y-2">
                        @csrf
                        <div class="bg-gradient2 py-2 px-5 rounded-t-lg">
                        ...
                        <div class="">
                            <input id="password" type="password"
                                class="form-input @error('password') error-field @enderror" required autocomplete="password"
                                autofocus placeholder="{{ trans('global.login_password') }}" name="password"
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="d-flex icheck-primary">
                    ...
                    @if (Route::has('password.request'))
                        <a class="mt-1 font-bold  float-right" href="{{ route('password.request') }}">

        ...
        <div class="flex flex-col space-y-4 my-2 md:my-0 lg:flex-row lg:mx-4">
            <div class="panel w-full sm:w-[70%] lg:w-[35%] mx-auto py-8">
                ...
                <form id="registration-form" action="{{ route('register') }}" method="POST"
                    ...
                    <div class="bg-gradient2 py-2 px-5 rounded-t-lg text-white">
                    ...
                    <button type="submit" id="submit" class="btn btn-primary text-white mt-3">
                        {{ __('Register') }}
                    </button>
                    <div class="flex w-full space-x-1 mx-auto justify-center">
                        Already have an account? 
                        <a href="{{ route('login') }}"
                            class="ml-2 text-primary"> Login
                        </a>
                    </div>
                </form>
            </div>

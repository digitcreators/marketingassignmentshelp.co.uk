                    ...
                    <table
                        ...
                        <tbody>
                            <tr>
                                <td colspan="4" valign="top"
                                    ...
                                    <a href="{{url('/')}}" target="_blank">
                                        <img  src="{{ asset('img/email-logo.png') }}" alt="{{env('APP_NAME', config('app.app_name'))}}" style="width: 180px; padding:5px">
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                            ...
                                            <tr>
                                                <td style="border-collapse:collapse;border:0;margin:0;padding:0;color:#555559;font-family:Arial,sans-serif;font-size:16px;line-height:26px">
                                                    <div>
                                                        ...
                                                        <hr>
                                                        @if($contact->name == 'General Inquiry')
                                                        ...
                                                        <br>
                                                        @if($contact->subject == 'General Inquiry')
                            ...
                            <tr bgcolor="#fff" style="border-top:4px solid #9c27b0;">
                                <td valign="top" style="border-collapse:collapse;border:0;margin:0;padding:0;color:#555559;font-family:Arial,sans-serif;font-size:16px;line-height:26px;background:#e6c5df;text-align:center">
                                    <table style="font-weight:normal;border-collapse:collapse;border:0;margin:0;padding:0;font-family:Arial,sans-serif">
                                        <tbody>
                                            <tr>

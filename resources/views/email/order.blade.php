    ...
    @if ($data['flag'] == true)
        <div style="margin-bottom: 15px;" class="">
            ...
            <table cellspacing="0" cellpadding="0" border="0" align="center" style="margin:20px auto;">
                <tr>
                    <td bgcolor="#4c2744" style="border-radius:8px;">
                        <table cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                <td align="center"
                                    style="font-size:16px; font-family:Arial, sans-serif; color:#ffffff; font-weight:bold; border: 4px solid ##0c1f4c;padding:12px 24px; display:block;">
    ...
    <table>
        ...
        @if (!empty($order->no_of_posters))
            <tr>
                ...
                <td
                    style="border: 2px solid #2e2f3b; text-align: left;padding: 8px;width: 14rem;color: #2e2f3b; font-size: 17px;">
                    <strong> {{ $order->no_of_posters ?? '-' }}</strong>
                </td>
        ...
        @if (!empty($order->no_of_slides))
            <tr>
                ...
                <td
                    style="border: 2px solid #2e2f3b; text-align: left;padding: 8px;width: 14rem;color: #2e2f3b; font-size: 17px;">
                    <strong> {{ $order->no_of_slides ?? '-' }}</strong>
                </td>
            </tr>
        @endif
        <tr>
        ...
        <tr>
            <th
                ...
                Total Cost</th>
            <td
                style="border: 2px solid #2e2f3b; text-align: left;padding: 8px;width: 14rem;color: #9c27b0; font-size: 17px;">
        ...
        <tr>
            <td bgcolor="#4c2744" style="border-radius:8px;">
                <table cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        <td align="center"
                            style="font-size:16px; font-family:Arial, sans-serif; color:#ffffff; font-weight:bold;padding:12px 24px; display:block;">
            ...
            <td bgcolor="#4c2744" style="border-radius:8px;">
                <table cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        <td align="center"
                            style="font-size:16px; font-family:Arial, sans-serif; color:#ffffff; font-weight:bold;padding:12px 24px; display:block;">
                            <a href="{{ route('invoice', ['reference' => $data['invoice']->ref_no]) }}"
                                style="color:#ffffff; text-decoration:none; display:block;">

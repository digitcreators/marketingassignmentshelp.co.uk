<div id="msg-bag"></div>
<form id="contact-form" method="POST" class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 pt-3">
    @csrf
    <div class="w-full space-y-2">
        <input type="text" name="name" class="form-select" placeholder="Enter your Name"
            value="{{ old('name', '') }}">
    </div>
    <div class="">
        <input type="text" id="email" name="email" class="form-select summary" placeholder="Enter your Email"
            value="{{ old('email', '') }}" />
    </div>
    <div class="">
        <input type="text" id="phone" name="phone" class="form-select summary  text-black"
    ...
    <select id="country" name="country" class="form-select summary text-gray-400" style="height: 45px;">
    ...
    <div class="w-full">
        <!-- Google Recaptcha -->
        <div class="g-recaptcha " id="home-recaptcha" data-sitekey={{ config('services.recaptcha.key') }}></div>
    </div>
    <button class="order-submit" type="submit" id="btn-submit" style="height: 45px;">

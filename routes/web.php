...
// Services
Route::get('/mba-dissertation', [ServiceController::class, 'dissertation'])->name('mba-dissertation');
Route::get('/mba-essay', [ServiceController::class, 'essay'])->name('mba-essay');
Route::get('/mba-personal-statement', [ServiceController::class, 'personal'])->name('mba-personal');
Route::get('/write-my-assignment', [ServiceController::class, 'write_my_assignment'])->name('write-my-assignment');
